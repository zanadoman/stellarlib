...
\
	for (const auto [res, rhs] : std::views::zip(res, rhs)) {\
		res = static_cast<std::common_type_t<T, U>>(lhs op rhs);\
	}\
\
	return res;\
}\
...
#undef STELLARLIB_LIN_MATRIX_BOOLEAN_OPERATOR_IMPL
#undef STELLARLIB_LIN_MATRIX_BINARY_OPERATOR_IMPL
#undef STELLARLIB_LIN_MATRIX_UNARY_OPERATOR_IMPL
#undef STELLARLIB_LIN_MATRIX_PREFIX_POSTFIX_OPERATOR_IMPL
#undef STELLARLIB_LIN_MATRIX_SWIZZLE_DOUBLE_IMPL
#undef STELLARLIB_LIN_MATRIX_SWIZZLE_SINGLE_IMPL
#undef STELLARLIB_LIN_MATRIX_ACCESSOR_DOUBLE_IMPL
#undef STELLARLIB_LIN_MATRIX_ACCESSOR_SINGLE_IMPL
